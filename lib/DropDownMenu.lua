...
function DropDownMenu.new( params )
    ...
    function dropDownMenu.onRowRender( event )
        ...
        local rowTitle  = display.newText(row, params.value, 0, 0, rowWidth, rowHeight, font6, fontSize)
        ...
        rowTitle.y = (rowHeight * 0.5) + fontSize*0.5 - 5
    ...
    buttonLabel = display.newText(dropDownMenu, cDefaultButtonValue, 0, 0, 0, buttonHeight, font6, fontSize)
    buttonLabel.y = (buttonHeight * 0.5) - (fontSize * 0.5) - 10
    buttonLabel.x = cDefaultCellXPadding
    --buttonLabel.y = buttonWidth * 0.5
    
    buttonLabel:setFillColor(0,0,1)
...
-- insert dummy background color

--[[    local function dumBackgroundTouch (event)
        if (event.phase == "began") then
             dropDownMenu:hideTable(true)
        end
    ...
    local dumBackground = display.newRect( 0, 0, w, h )
    dumBackground.anchorX = 0
    dumBackground.anchorY = 0
    dumBackground.x = 0
    dumBackground.y = 0
    dumBackground:setFillColor( 10/255, 100/255, 200/255 )
    dumBackground.alpha = 0.01
    


    dumBackground:addEventListener( "touch", dumBackgroundTouch )]]--
